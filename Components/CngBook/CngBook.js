...
import CngListOptions from "../CngBook/CngListOptions";
import InputItem from "../CngBook/InputItem";
...
export default function CngBook() {
            ...
            <Row className="mt-5">
                <Col md={5} className='border p-4'>
                    <div>
                        ...
                        <div>{distance ? <CngListOptions distance={distance} /> : null}</div>
                    </div>
                </Col>
